    ...
    >
      ...
      >
        ...
        >
            ...
            <thead>
              <tr>
                ...
                >
                  ...
                  <hr>
                  <label class=" text-black">Fiche de Restitution Matériel Informatique </label>
                </td>
          ...
          <b-col class="ml-2">
            <h6 class="mb-2">
              <span class="mr-1">√</span> Rendu Par : <span class="title-value">{{ salarie.full_name }}</span>
            </h6>
            <h6 class="mb-2">
          ...
          <table class="table table-bordered">
            <thead>
              <tr class="text-center text-black">
                ...
                <th>Date restitution Matériel</th>
                <th>Raison</th>
                <th>
                  Remarque
                </th>
            ...
            <tbody>
              ...
              >
                ...
                <td>{{ item.pivot.rendu_at }}</td>
                <td>{{ item.pivot.raison }}</td>
  ...
  computed: {
    laptops() {
      ...
      if (typeof data === 'string' && this.tryParseJSONObject(data)) {
        return JSON.parse(data).returned_laptops
      }
      return []
    },
    salarie() {
